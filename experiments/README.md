...
| File | Description |
|------|-------------|
| `_shared.py` | E45 data loading, profile building, Richardson extrapolation, character definitions, L-function evaluation, fitting utilities, D-odd enumeration. Imported by L06–L11. |
